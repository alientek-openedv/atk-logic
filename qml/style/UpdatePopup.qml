...
Rectangle {
    ...
    property bool showNotRemindButton
        ...
        Rectangle{
            ...
            Item{
                ...
                QTextEdit{
                    id: showEdit
                    width: parent.width
                    height: parent.height-titleText.height-subRow.height-(notRemindCheckBox.visible?16:10)
                ...
                TextButton{
                    id: notRemindCheckBox
                    text: qsTr("不再提醒此版本")
                    textFontSize: 14
                    textUnderline: true
                    textColor: Config.mouseCheckColor
                    textEnterColor: Config.subheadColor
                    visible: showNotRemindButton
                    anchors{
                        top: showEdit.bottom
                        topMargin: 2
                    }
                    onPressed: {
                        Setting.notRemindVersion=version;
                        Setting.save();
                        rootControl.visible=false
                    }
                }
