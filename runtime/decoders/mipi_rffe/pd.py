...
## Copyright (C) 2024 ALIENTEK (正点原子) <xiaoshitou@39035605@qq.com>
##
...
class Decoder(srd.Decoder):
    ...
    channels = (
        ...
        {'id': 'sdata', 'name': 'SDATA', 'desc': 'Serial data line'},
    )
    options = (
    ...
    annotations = (
        ...
        ('Bus Idle Condition ', 'Bus Idle Condition '),
        ('BC warnings', 'BC warnings'),
        ('Illegal Jump Edge', 'IJE_WAEN'),
        ('Parity warnings', 'Parity warnings'),
    )
    annotation_rows = (
